...
class kabusday extends Exchange {
    ...
    public function prepare_order($symbol, $type, $side, $amount, $price, $params = array ()) {
        ...
        return array(
            ...
            'CashMargin' => $reduceOnly ? 3 : 2, // 新規(2) 返済(3)
            'DelivType' => $reduceOnly ? 2 : 0, // 現物買&信用返済→預り金(2) *信用新規&現物売→指定なし(0)
            'Qty' => $amount,
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) {
        ...
        $orderParam = $this->prepare_order($symbol, $type, $side, $amount, $price, $params);
        $body = array(
    ...
    public function parse_balance($response) {
        ...
        $account['free'] = $this->safe_float($response, 'MarginAccountWallet');
        $result['JPY'] = $account;
        return $result;
    }
    ...
    public function fetch_balance($params = array ()) {
        ...
        yield $this->load_markets();
        $response = yield $this->privateGetWalletMargin ($params);
        // {
