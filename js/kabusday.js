...
module.exports = class kabusday extends Exchange {
    describe () {
    ...
    prepareOrder (symbol, type, side, amount, price, params = {}) {
    ...
    async createOrder (symbol, type, side, amount, price = undefined, params = {}) {
        ...
        const orderParam = this.prepareOrder (symbol, type, side, amount, price, params);
        const body = {
    ...
    parseBalance (response) {
        ...
        account['free'] = this.safeFloat (response, 'MarginAccountWallet');
        result['JPY'] = account;
        return result;
    }
    ...
    async fetchBalance (params = {}) {
        ...
        await this.loadMarkets ();
        const response = await this.privateGetWalletMargin (params);
        // {
